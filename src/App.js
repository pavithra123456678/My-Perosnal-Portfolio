  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white font-sans">
      ...
      <section className="bg-gradient-to-r from-indigo-900 to-purple-900 flex flex-col items-center justify-center text-center h-screen pt-20 px-4 text-white">
        ...
        <h2 className="text-2xl text-indigo-200 mb-4">Software Engineer | AI/ML Enthusiast</h2>
        <p className="max-w-xl mb-4">
          Building intelligent systems with NLP, machine learning, and generative AI.
        </p>
        <p className="max-w-xl">
          Final-year CSE student (CGPA 9.4/10) passionate about applying AI and full-stack engineering to solve real problems.
        </p>
        <a
      ...
      <section id="summary" className="max-w-4xl mx-auto px-6 py-16">
        ...
        <p>
          Motivated Computer Science Engineering student with hands-on experience across cybersecurity, full-stack development, and data integration internships. Proficient in Python, machine learning fundamentals (XGBoost), NLP techniques (TF-IDF, cosine similarity), and generative AI (Gemini API). Passionate about applying AI/ML to build practical, intelligent software solutions.
        </p>
      </section>
      ...
      <section id="skills" className="bg-gray-800 py-16 px-6">
        ...
        <div className="max-w-4xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
          <div>
            <h3 className="font-semibold mb-3 text-indigo-400">AI / ML</h3>
            <ul className="space-y-2">
              {["Python", "Machine Learning (XGBoost)", "NLP (TF-IDF, Cosine Similarity)", "Gemini API", "Prompt Engineering"].map(skill => (
                <li key={skill} className="bg-gray-700 rounded-md py-2">{skill}</li>
              ))}
            </ul>
          </div>
          <div>
            <h3 className="font-semibold mb-3 text-indigo-400">Backend & APIs</h3>
            <ul className="space-y-2">
              {["Java", "REST APIs", "JWT Authentication", "MySQL", "MongoDB"].map(skill => (
                <li key={skill} className="bg-gray-700 rounded-md py-2">{skill}</li>
              ))}
            </ul>
          </div>
          <div>
            <h3 className="font-semibold mb-3 text-indigo-400">Frontend & Tools</h3>
            <ul className="space-y-2">
              {["HTML", "CSS", "JavaScript", "Git & GitHub", "Postman"].map(skill => (
                <li key={skill} className="bg-gray-700 rounded-md py-2">{skill}</li>
              ))}
            </ul>
          </div>
      ...
      <section id="experience" className="max-w-4xl mx-auto px-6 py-16">
        ...
        <div className="space-y-8">
          <div>
            ...
            <p className="italic text-indigo-400">Feb 2025 – May 2025 (Remote)</p>
          ...
          <div>
            <h3 className="text-xl font-semibold">Full Stack Developer Intern | Codebind Technologies</h3>
            <p className="italic text-indigo-400">June 2024 | Chennai</p>
            <ul className="list-disc list-inside">
          ...
          <div>
            <h3 className="text-xl font-semibold">Data Integration Intern | NSIIC</h3>
            <p className="italic text-indigo-400">July 2023 | Chennai</p>
            <ul className="list-disc list-inside">
      ...
      <section id="projects" className="bg-gray-800 py-16 px-6">
        ...
        <div className="max-w-4xl mx-auto space-y-8">
          <div>
            <h3 className="text-xl font-semibold">AI Student Developer Kit</h3>
            <p className="italic text-indigo-400">Technologies: Python, NLP (TF-IDF, Cosine Similarity), XGBoost, Gemini API, REST APIs, JWT Authentication</p>
            <p>Built a candidate-role match scoring system using an XGBoost model, with keyword/rule-based skill-gap analysis and secure REST APIs.</p>
          </div>
          <div>
            <h3 className="text-xl font-semibold">AI Image Generator</h3>
            <p className="italic text-indigo-400">Technologies: Python, Gemini API, Prompt Engineering, Generative AI</p>
            <p>Multi-step agentic workflow for AI image generation, featuring prompt chaining, retry logic, and structured evaluation of outputs.</p>
          </div>
          <div>
            <h3 className="text-xl font-semibold">Shrimp Detection System</h3>
            <p className="italic text-indigo-400">Technologies: Python, OpenCV</p>
            <p>Six-stage image processing pipeline for detecting and analyzing shrimp in images.</p>
          </div>
          <div>
            <h3 className="text-xl font-semibold">TaskFlow Task Management API</h3>
            <p className="italic text-indigo-400">Technologies: Java, MySQL, Postman</p>
            <p>A task management REST API with basic authentication, tested and documented using Postman.</p>
          </div>
          <div>
      ...
      <section id="education" className="max-w-4xl mx-auto px-6 py-16">
        ...
        <p>
          ...
          Hindustan Institute of Technology and Science | CGPA: 9.4/10 | Expected Graduation: 2026
        </p>
        <p className="mt-4">
          Focused academic coursework in core computer science areas including programming, machine learning, web development, and cybersecurity, with hands-on projects and internship experience complementing theoretical knowledge.
        </p>
        <p className="mt-4">
          <strong>Certification:</strong> Oracle Cloud Infrastructure 2025 AI Foundations Associate
        </p>
      </section>
